...
legend.onAdd = function() {
  ...
  let tectonicBoundaryData = "https://raw.githubusercontent.com/jshehan29/Mapping_Earthquakes/main/PB2002_boundaries.json";

  d3.json(tectonicBoundaryData).then(function(data) {
    console.log(data);
    // Creating a GeoJSON layer with the retrieved data.
    L.geoJson(data, {
      weight: 3,
